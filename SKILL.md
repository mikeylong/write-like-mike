...
- reveal or quote Gmail-derived source material
...
This skill does not guarantee legal, medical, financial, HR, or compliance review. For high-stakes content, preserve the voice but surface uncertainty and recommend appropriate review.
...
- `Write this as me: I can meet Tuesday after 2, thank them for the context, ask whether they want a portfolio link.`
- `Rewrite this memo so it sounds like Mike, but keep the argument intact.`
- `Draft a short update from these notes in my voice.`
- `Make this Slack message more like me: direct, useful, not corporate.`
